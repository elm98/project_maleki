(function($){
	...
	$.each(all_converter,function(e){
		...
		if (numHyphen < numHyphen_next) {
		    ...
		    item = item + '<i class="material-icons cursor-pointer">add</i>' + "\n";
	...
	SymbolPrefix: "fa",
	expandedSymbol: "fa-chevron-down",
	collapsedSymbol: "fa-chevron-left",
	collapseAll: true,
	checkboxes: "enabled",
	...
	hoverColorBg2: "transparent",
	hoverColorText1: "transparent",
