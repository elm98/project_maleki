...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 05, 2023 at 05:01 AM
...
CREATE TABLE IF NOT EXISTS `ms011_post` (
  ...
  `edit_by` text COLLATE utf8mb4_persian_ci NOT NULL,
  `created_by` int(11) DEFAULT NULL,
  `cats` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `access_type` text COLLATE utf8mb4_persian_ci NOT NULL,
  `view` int(11) DEFAULT '0' COMMENT 'تعداد بازدید این مطلب',
  `info` text COLLATE utf8mb4_persian_ci,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=100 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_persian_ci;
...
) ENGINE=MyISAM AUTO_INCREMENT=439 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(412, 'admin', 0, 'administrator', '09115119590', 'محمد شجاع', 'محمد', 'شجاع', NULL, 'mohammadshoja65@gmail.com', '$2y$10$aUqGnUr2H.AOGsAHQ8Nd/.KoaPv9nFh.NnlCpyd6Segx64FYXfDbS', 0, '', '922054210', '0.0', 0, '0.00', 'active', 'کمربندی بعد از میدان کشوری', 27, 588, '26598989', '', '', NULL, '1986-05-23 00:00:00', '', 'man', '3433911965.jpg', NULL, '', 0, 'UyfE8IzNf88vBmgzlqXU85YiXbvbLZDn8hMvHi3wgxlrXgHjHCo5E1ifYqO9', '11111', '', 'eyJpdiI6ImgwUU1qQ2NXa3FVNlRodXVKc1VjVnc9PSIsInZhbHVlIjoidHRMSHVlWFZBYktYczZTRjlXT21QZz09IiwibWFjIjoiZGFmZDM4MTE4ZDcxYzNiN2QwZGVjMTI2YjQyZDk3YzY0MDkwNzM1NTViNjVkMzI4MDA0NjBiMTU0YjM0MWIyOCIsInRhZyI6IiJ9', 412, '203201', 0, NULL, NULL, NULL, '2021-02-07 07:30:42', '2022-12-31 08:35:59'),
