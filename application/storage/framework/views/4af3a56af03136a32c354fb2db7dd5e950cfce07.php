        ...
        <div class="col s12 m12 l12">
            <div class="card card-round">
                <div class="card-header rounded  gradient-45deg-light-blue-cyan gradient-shadow">
                    <div class="title"> لیست همه مدیران و پرسنل <i class="material-icons left white-text">people</i> </div>
                    <div class="tools">
                        <a href="<?php echo e(url('/management/user-add')); ?>" class="waves-effect waves-blue btn white black-text">
                    ...
                    <div class="row">
                        <div class="col s12 section-data-tables scrollspy">
                            ...
                            <div class="action-button mt-2">
                                <button class="btn rows-delete--" onclick="helper().rows_delete('user-delete')" data-action="user-delete">حذف دسته جمعی<i class="material-icons left">delete</i></button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(function () {
            var dt=$("#my-dt").DataTable({
                ...
                ajax: {
                    url: '<?php echo e(url("/management/user-list-dt")); ?>',
                    type: "POST",
                    dataType: "json",
                    delay:5000,
                    data:
...
<?php echo $__env->make('back-end.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\mis_maleki\application\resources\views/back-end/user_list.blade.php ENDPATH**/ ?>