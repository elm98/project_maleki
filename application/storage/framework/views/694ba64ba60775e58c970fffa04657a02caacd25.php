                        ...
                        <div id="general">
                            <div class="card-panel">
                                <div class="display-flex">
                                    <div class="media">
                                        <img src="<?php echo e($dotSlashes); ?>back/custom/img/avatar.png" id="media-img" class="border-radius-4" alt="profile image" height="64" width="64">
                                    </div>
                                    <div class="media-body">
                                        <div class="general-action-btn">
                                            ...
                                            <button class="btn btn-light-pink iransans" onclick="$('#upfile').val(null);$('#media-img').attr('src','<?php echo e($dotSlashes); ?>back/custom/img/avatar.png');$('#avatar').val('')">تنظیم مجدد</button>
                                        </div>
                                ...
                                <form class="formValidate form-valid send-ajax" method="post" action="<?php echo e(url('/management/user-insert')); ?>" data-after-done="after_done">
                                    <div class="row">
...
<?php $__env->startSection('footerScript'); ?>
    ...
    <script>
        function after_done() {
            setTimeout(function () {
                window.location.href='<?php echo e(url('/management/user-list')); ?>';
            },2000)
        }
    </script>
...
<?php echo $__env->make('back-end.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\mis_maleki\application\resources\views/back-end/user_add.blade.php ENDPATH**/ ?>