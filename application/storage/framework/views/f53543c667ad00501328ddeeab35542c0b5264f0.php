<div id="theme-cutomizer-out" class="theme-cutomizer sidenav row">
    <div class="col s12">
        ...
        <h6 class="theme-cutomizer-title">تم دلخواه خود را بوجود آورید</h6>
        ...
        <div class="menu-options">
            ...
            <div class="menu-options-form row">
                <div class="input-field col s12 menu-color mb-0">
                    ...
                    <div class="gradient-color left-align">
                        ...
                        <span class="menu-color-option gradient-45deg-indigo-purple" data-color="gradient-45deg-indigo-purple"></span>
                    </div>
                    <div class="solid-color left-align">
                ...
                <div class="input-field col s12 menu-bg-color mb-0">
                    ...
                    <div class="gradient-color left-align">
                        ...
                        <span class="menu-bg-color-option gradient-45deg-indigo-purple" data-color="gradient-45deg-indigo-purple"></span>
                    </div>
                    <div class="solid-color left-align">
        ...
        <div class="navbar-options row">
            <div class="input-field col s12 navbar-color mb-0">
                ...
                <div class="gradient-color left-align">
                    ...
                    <span class="navbar-color-option gradient-45deg-indigo-purple" data-color="gradient-45deg-indigo-purple"></span>
                </div>
                <div class="solid-color left-align">
        ...
        <div class="navbar-options row">
            ...
            <div class="row center-align ">
                <div class="col m12 pt-5">
                    <button type="button" id="save-setting-my-them" class="btn">برای ذخیره تغییرات کلیک کنید</button>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\wamp64\www\mis_maleki\application\resources\views/back-end/layout/setting.blade.php ENDPATH**/ ?>