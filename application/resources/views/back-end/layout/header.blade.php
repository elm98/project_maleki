        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
            <div class="nav-wrapper">
                ...
                <ul class="navbar-list right">
                    <!--language-->{{--<li class="dropdown-language"><a class="waves-effect waves-block waves-light translation-button" href="#" data-target="translation-dropdown"><span class="flag-icon flag-icon-ir"></span></a></li>--}}
                    <li class="hide-on-med-and-down"><a class="waves-effect waves-block waves-light toggle-fullscreen" href="javascript:void(0);"><i class="material-icons">settings_overscan</i></a></li>
                    <!--Notify-->@if($options['notify'] == 'enable')<li><a class="waves-effect waves-block waves-light sidenav-trigger" href="{{url('/management/notify-list')}}" ><i class="material-icons" id="notify-counter-i">notifications_none<small id="notify-counter-n" class="notification-badge grey">0</small></i></a></li>@endif
                    <!--avatar--><li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img onerror="this.src='{{_noImage('avatar.png')}}'" src="{{_slash('uploads/avatar/'.$auth->user_avatar)}}" alt="{{$auth->user_nickname}}" style="box-shadow: 0 0 3px 3px rgba(255, 255, 255 , 0.37);"><i></i></span></a></li>
                    ...
                    <!--leftSidebar-->{{--<li><a class="waves-effect waves-block waves-light sidenav-trigger" href="#" data-target="slide-out-right"><i class="material-icons">format_indent_increase</i></a></li>--}}
                </ul>
                ...
                <ul class="dropdown-content" id="notifications-dropdown">
                    ...
                    <li>
                        <a class="blue-text center-align" href="{{url('/management/notify-list')}}"><span class="material-icons   ">notifications_active</span>نمایش همه</a>
                    </li>
                </ul>

                <!-- profile-dropdown پروفایل -->
                <ul class="dropdown-content" id="profile-dropdown">
                    <li><a class="grey-text text-darken-1 font-medium" href="{{url('/management/profile')}}"><i class="material-icons">person_outline</i> مشخصات</a></li>
                    <li><a class="grey-text text-darken-1 font-medium" href="{{url('/management/comment-list?user_id='.$auth->user_id)}}"><i class="material-icons">chat_bubble_outline</i>  دیدگاه من</a></li>
                    <li><a class="grey-text text-darken-1 font-medium" href="{{url('/management/access-denied')}}"><i class="material-icons">help_outline</i> راهنمایی</a></li>
                    <li class="divider"></li>
