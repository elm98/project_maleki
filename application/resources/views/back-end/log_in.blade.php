...
<head>
    ...
    <link rel="apple-touch-icon" href="{{\App\Models\Option::get_img('logo_small','setting')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{\App\Models\Option::get_img('logo_small','setting')}}">
    <!-- BEGIN: VENDOR CSS-->
                    ...
                    <form id="formValidate" method="post" action="logged-in" class="login-form">
                        ...
                        {{--<div class="row">
                            <div class="input-field col s6 m6 l6">
                                <p class="margin medium-small"><a href="user-register.html">اکنون ثبت نام کنید</a></p>
                            </div>
                            <div class="input-field col s6 m6 l6">
