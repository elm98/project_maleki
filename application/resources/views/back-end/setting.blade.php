                    ...
                    <div class="col l8 s12 ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12">
                                            <div class="input-field">
                                                ...
                                                <input type="text" name="optionKey_blog_title" required value="{{Option::find_key($option,'blog_title')}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col m12 s12">
                                            <div class="input-field">
                                                <textarea name="optionKey_description" class="materialize-textarea" >{{Option::find_key($option,'description')}}</textarea>
                                                <label>توضیحات</label>
                                            </div>
                                        </div>
                                        <div class="col s12">
                                            <div class="input-field">
                                                <select name="tags[]" class="browser-default select2_tag" multiple>
                                                    @foreach(explode(',',Option::find_key($option,'tags')) as $item)
                                        ...
                                        <div class="col s12 mt-2">
                                            <div class="input-field">
                                                ...
                                                <input type="text" dir="ltr" name="optionKey_email" value="{{Option::find_key($option,'email')}}" autocomplete="off">
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col m6 s6 input-field">
                                                    ...
                                                    <select class="browser-default select2" name="optionKey_state" onchange="helper().setCitySelectBox(this.value,'city')">
                                                        ...
                                                        <option value="{{$state->id}}" {{intval(Option::find_key($option,'state')) == $state->id?'selected':''}}>{{$state->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col m6 s6 input-field">
                                                    ...
                                                    <select id="city" class="browser-default select2" name="optionKey_city">
                                                        @foreach(getCity(intval(Option::find_key($option,'state'))) as $city)
                                                            <option value="{{$city->id}}" {{Option::find_key($option,'city') == $city->id?'selected':''}}>{{$city->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col m6 s12">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_notify" value="enable" type="radio" {{Option::find_key($option,'notify') == 'enable'?'checked':''}}>
                                                        <span>فعال</span>
                                                    </label>
                                                </div>
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_notify" value="disable" type="radio" {{Option::find_key($option,'notify') == 'disable'?'checked':''}}>
                                                        <span>غیر فعال</span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col m6 s12">
                                            <div class="input-field">
                                                ...
                                                <input type="number" name="optionKey_refresh_time" value="{{Option::find_key($option,'refresh_time')}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col s12 mt-4">
                                            <div class="input-field">
                                                ...
                                                <textarea id="footer_copy_write" type="text" name="optionKey_footer_copy_write" class="browser-default width-100" rows="10" autocomplete="off">{{Option::find_key($option,'footer_copy_write')}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col s12">
                                            <hr/>
                        ...
                        <div id="tab2">
                            <div class="card-panel ">
                                ...
                                {{--<form id="form2" class="form-valid1 send-ajax" method="post" action="{{url('/management/setting-update')}}" data-after-done="after_done2">
                                    {{csrf_field()}}
                                    <div class="row">
                                        <div class="col s12">
                                            <div class="input-field">
                                                <label>آدرس سرور پیامکی</label>
                                                <input type="text" name="optionKey_sms_server" required dir="ltr" placeholder="مشخصات را وارد کنید" value="{{Option::find_key($option,'sms_server')}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col s12">
                                            <div class="input-field">
                                                <label>نام کاربری</label>
                                                <input type="text" name="optionKey_sms_user" required dir="ltr" placeholder="مشخصات را وارد کنید" value="{{Option::find_key($option,'sms_user')}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col s12">
                                            <div class="input-field">
                                                <label>رمز عبور</label>
                                                <input type="text" name="optionKey_sms_password" required dir="ltr" placeholder="مشخصات را وارد کنید" value="{{Option::find_key($option,'sms_password')}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col s12">
                                            <div class="input-field">
                                                <label>شماره خط</label>
                                                <input type="text" name="optionKey_sms_line" required dir="ltr" placeholder="مشخصات را وارد کنید" value="{{Option::find_key($option,'sms_line')}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col s12 display-flex justify-content-end form-action">
                                ...
                                <div class="row" style="display: flex;flex-wrap: wrap;margin-top:15px">
                                    ...
                                    <div class="col s12 mb-3" >
                                        <div class="gateway">
                                            ...
                                            <form class="send-ajax" method="post" action="{{url('/management/json-save')}}">
                                                {{csrf_field()}}
                                                ...
                                                <div class="input-field">
                                                    <p>آدرس سرور</p>
                                                    <input type="text" required dir="ltr" name="optionJson_server" value="{{$opt->server}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>نام کاربری</p>
                                                    <input type="text" required dir="ltr" name="optionJson_user" value="{{$opt->user}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>رمز عبور</p>
                                                    <input type="text" required dir="ltr" name="optionJson_pass" value="{{$opt->pass}}" autocomplete="off">
                                                </div>
                                                <div class="">
                                                    <label>
                                                        <input type="radio" class="filled-in" name="smsPanelDefault" value="smsPanel_inductor" {{Option::find_key($option,'smsPanelDefault')=="smsPanel_inductor"?'checked':''}}>
                                    ...
                                    <div class="col s12 mb-3" >
                                        <div class="gateway">
                                            ...
                                            <form class="send-ajax" method="post" action="{{url('/management/json-save')}}">
                                                ...
                                                <div class="input-field">
                                                    <p>شماره خط</p>
                                                    <input type="text" required dir="ltr" name="optionJson_lineNumber" value="{{$opt->lineNumber}}" autocomplete="off">
                                                </div>
                                                <div class="">
                                                    <label>
                                                        <input type="radio" class="filled-in" name="smsPanelDefault" value="smsPanel_niazpardaz" {{Option::find_key($option,'smsPanelDefault')=="smsPanel_niazpardaz"?'checked':''}}>
                                                        <span>به عنوان پیش فرض</span>
                                                    </label>
                                                </div>
                                                <div class="right-align">
                                        ...
                                        <div class="gateway">
                                            ...
                                            <form class="send-ajax" method="post" action="{{url('/management/json-save')}}">
                                                ...
                                                <div class="input-field">
                                                    ...
                                                    <input type="text" required dir="ltr" name="optionJson_api" value="{{$opt->api}}" autocomplete="off">
                                                </div>
                                                <div class="">
                                                    <label>
                                                        <input type="radio" class="filled-in" name="smsPanelDefault" value="smsPanel_kavenegar" {{Option::find_key($option,'smsPanelDefault')=="smsPanel_kavenegar"?'checked':''}}>
                                                        <span>به عنوان پیش فرض</span>
                                                    </label>
                                                </div>
                                                <div class="right-align">
                                    ...
                                    <div class="col s12 mb-3" >
                                        <div class="gateway">
                                            ...
                                            <form class="send-ajax" method="post" action="{{url('/management/json-save')}}">
                                                ...
                                                <div class="">
                                                    <label>
                                                        <input type="radio" class="filled-in" name="smsPanelDefault" value="smsPanel_mellipayamak" {{Option::find_key($option,'smsPanelDefault')=="smsPanel_mellipayamak"?'checked':''}}>
                                                        <span>به عنوان پیش فرض</span>
                                                    </label>
                                                </div>
                                                <div class="right-align">
                                    ...
                                    <div class="col s12 mb-3" >
                                        <div class="gateway">
                                            ...
                                            <form class="send-ajax" method="post" action="{{url('/management/json-save')}}">
                                                ...
                                                <div class="input-field">
                                                    <p>API KEY</p>
                                                    <input type="text" required dir="ltr" name="optionJson_apikey" value="{{$opt->apikey}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>SECRET KEY</p>
                                                    <input type="text" required dir="ltr" name="optionJson_secretkey" value="{{$opt->secretkey}}" autocomplete="off">
                                                </div>
                                                <div class="">
                                                    <label>
                                                        <input type="radio" class="filled-in" name="smsPanelDefault" value="smsPanel_smsir" {{Option::find_key($option,'smsPanelDefault')=="smsPanel_smsir"?'checked':''}}>
                                                        <span>به عنوان پیش فرض</span>
                                                    </label>
                                                </div>
                                                <div class="right-align">
                            ...
                            <div class="card-panel">
                                ...
                                <div class="row">
                                    <div class="col m6 s12 center-align">
                                        <form class="send-ajax" method="post" action="{{url('/management/setting-image-update')}}">
                                            {{csrf_field()}}
                                            <div class="w-100">
                                                <p class="font-medium">لوگوی اصلی</p>
                                                <p class="font-small">JPG یا PNG مجاز است. حداکثر اندازه 200kB</p>
                                            </div>
                                            <img src="{{_slash('uploads/setting/'.Option::find_key($option,'logo'))}}" onerror="this.src='{{_noImage('avatar.png')}}'" id="img1" class="border-radius-4" alt="profile image" style="max-height:100px;max-width:100%">
                                    ...
                                    <div class="col m6 s12 center-align" style="background: #0b0b0b">
                                        <form class="send-ajax" method="post" action="{{url('/management/setting-image-update')}}">
                                            ...
                                            <img src="{{_slash('uploads/setting/'.Option::find_key($option,'logo_dark'))}}" onerror="this.src='{{_noImage('avatar.png')}}'" id="img2" class="border-radius-4" alt="profile image" style="max-height:100px;max-width:100%">
                                            <div class="center-align">
                                    ...
                                    <div class="col m12 s12 center-align">
                                        <form class="send-ajax" method="post" action="{{url('/management/setting-image-update')}}">
                                            ...
                                            <img id="img3" src="{{_slash('uploads/setting/'.Option::find_key($option,'favicon'))}}" onerror="this.src='{{_noImage('avatar.png')}}'" class="border-radius-4" alt="profile image" style="max-height:70px;max-width:100%">
                                            <div class="center-align">
                                    ...
                                    <form id="form2" class="form-valid1 send-ajax" method="post" action="{{url('/management/setting-update')}}" >
                                        {{csrf_field()}}
                                        <div class="col s12 mt-2">
                                            <div class="input-field">
                                                <p>تصویر اصالت سایت (ای نماد)</p>
                                                <input type="text" name="optionKey_namad1" value="{{Option::find_key($option,'namad1')}}" autocomplete="off" placeholder="کد ، متن یا آدرس تصویر ای نماد را وارد کنید">
                                            </div>
                                        </div>
                                        <div class="col s12 mt-2">
                                            <div class="input-field">
                                                <p>تصویر اصالت سایت (شماره 2)</p>
                                                <input type="text" name="optionKey_namad2" value="{{Option::find_key($option,'namad2')}}" autocomplete="off" placeholder="کد ، متن یا آدرس تصویر نماد را وارد کنید">
                                            </div>
                                        </div>
                                        <div class="col s12 mt-2">
                                            <div class="input-field">
                                                <p>تصویر اصالت سایت (شماره 3)</p>
                                                <input type="text" name="optionKey_namad3" value="{{Option::find_key($option,'namad3')}}" autocomplete="off" placeholder="کد ، متن یا آدرس تصویر نماد را وارد کنید">
                                            </div>
                                        </div>
                                        <div class="col m12 s12">
                                    ...
                                    <div class="col s12 mb-3" >
                                        <div class="gateway ">
                                            ...
                                            <form class="send-ajax" method="post" action="{{url('/management/json-save')}}">
                                                ...
                                                <div class="input-field">
                                                    <p>شماره ترمینال</p>
                                                    <input type="text" required dir="ltr" name="optionJson_terminalNumber" value="{{$opt->terminalNumber}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>پین کد</p>
                                                    <input type="text" required dir="ltr" name="optionJson_pinCode" value="{{$opt->pinCode}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>ضریب مبلغ درگاه</p>
                                                    <input type="number" required dir="ltr" name="optionJson_factorAmount" value="{{$opt->factorAmount}}" autocomplete="off">
                                                    <span class="font-small">مثلا برای تبدیل تومان به ریال ضریب 10 نیاز است</span>
                                                </div>
                                                <div class="">
                                                    <label>
                                                        <input type="checkbox" class="filled-in" name="optionJson_active" value="true" {{$opt->active=="true"?'checked':''}}>
                                    ...
                                    <div class="col s12 mb-3" >
                                        <div class="gateway ">
                                            ...
                                            <form class="send-ajax" method="post" action="{{url('/management/json-save')}}">
                                                ...
                                                <div class="input-field">
                                                    <p>مرچنت ایدی</p>
                                                    <input type="text" required dir="ltr" name="optionJson_merchantId" value="{{$opt->merchantId}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>کلید</p>
                                                    <input type="text" required dir="ltr" name="optionJson_key" value="{{$opt->key}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>ضریب مبلغ درگاه</p>
                                                    <input type="number" required dir="ltr" name="optionJson_factorAmount" value="{{$opt->factorAmount}}" autocomplete="off">
                                    ...
                                    <div class="col s12 mb-3" >
                                        <div class="gateway ">
                                            ...
                                            <form class="send-ajax" method="post" action="{{url('/management/json-save')}}">
                                                ...
                                                <div class="input-field">
                                                    <p>شماره پایانه</p>
                                                    <input type="text" required dir="ltr" name="optionJson_terminalId" value="{{$opt->terminalId}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>نام کاربری</p>
                                                    <input type="text" required dir="ltr" name="optionJson_userName" value="{{$opt->userName}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>رمز عبور</p>
                                                    <input type="text" required dir="ltr" name="optionJson_userPassword" value="{{$opt->userPassword}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>ضریب مبلغ درگاه</p>
                                                    <input type="number" required dir="ltr" name="optionJson_factorAmount" value="{{$opt->factorAmount}}" autocomplete="off">
                                    ...
                                    <div class="col s12 mb-3" >
                                        <div class="gateway ">
                                            ...
                                            <form class="send-ajax" method="post" action="{{url('/management/json-save')}}">
                                                ...
                                                <div class="input-field">
                                                    <p>رمز عبور</p>
                                                    <input type="text" required dir="ltr" name="optionJson_password" value="{{$opt->password}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>کد پذیرنده</p>
                                                    <input type="text" required dir="ltr" name="optionJson_acceptorId" value="{{$opt->acceptorId}}" autocomplete="off">
                                                </div>
                                                <div class="input-field">
                                                    <p>کلید اختصاصی</p>
                                                    <textarea class="browser-default w-100" rows="10" required dir="ltr" name="optionJson_pubKey" autocomplete="off">{{$opt->pubKey}}</textarea>
                                                </div>
                                                <div class="input-field">
                                                    <p>ضریب مبلغ درگاه</p>
                                                    <input type="number" required dir="ltr" name="optionJson_factorAmount" value="{{$opt->factorAmount}}" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12">
                                            <div class="input-field">
                                                ...
                                                <input type="text" dir="ltr" class="text-center" name="optionKey_invoice_prefix" required value="{{Option::find_key($option,'invoice_prefix')}}" autocomplete="off">
                                            </div>
                                        </div>
                                        {{--<div class="col m12 s12">
                                            <div class="row mb-5">
                                                <div class="col m12 s12">
                                                    <p><i class="material-icons left">store</i>چند فروشندگی :</p>
                                                </div>
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_send_by_seller" value="yes" type="radio" {{Option::find_key($option,'send_by_seller') == 'yes'?'checked':''}}>
                                                        <span>ارسال کالا توسط فروشنده</span>
                                                    </label>
                                                </div>
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_send_by_seller" value="no" type="radio" {{Option::find_key($option,'send_by_seller') == 'no'?'checked':''}}>
                                                        <span>ارسال کالا توسط مرکز پردازش</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>--}}
                                        ...
                                        <div class="col s12">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col m4 s12 ">
                                                    <label>
                                                        <input name="optionKey_multiStore" value="enable" type="radio" {{Option::find_key($option,'multiStore') == 'enable'?'checked':''}}>
                                                        <span>فعال</span>
                                                    </label>
                                                </div>
                                                <div class="col m4 s12 ">
                                                    <label>
                                                        <input name="optionKey_multiStore" value="disable" type="radio" {{Option::find_key($option,'multiStore') == 'disable'?'checked':''}}>
                                                        <span>غیر فعال</span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col s6 mt-2">
                                            <div class="input-field">
                                                ...
                                                <input type="text" name="optionKey_currency" value="{{Option::find_key($option,'currency')}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col s6 mt-2">
                                            <div class="input-field">
                                                <label>درصد مالیات</label>
                                                <input type="number" step="0.01" name="optionKey_tax" value="{{Option::find_key($option,'tax')}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col s6 mt-2">
                                            <div class="input-field">
                                                <label>مدت زمان پرداخت فاکتور (به ساعت)</label>
                                                <input type="number" dir="ltr" step="1" name="optionKey_expire_invoice_payment" value="{{Option::find_key($option,'expire_invoice_payment')}}" autocomplete="off" class="text-center">
                                            </div>
                                        </div>
                                        <div class="col s6 mt-2">
                                            <div class="input-field">
                                                <label>محدوده اخطار تعداد موجودی</label>
                                                <input type="number" dir="ltr" name="optionKey_count_limit" value="{{Option::find_key($option,'count_limit')}}" autocomplete="off" class="text-center">
                                            </div>
                                        </div>
                                        <div class="col m12 s12 mb-3 pb-3 grey lighten-3">
                                            <div class="row ">
                                                ...
                                                <div class="col m4 s12 ">
                                                    <label>
                                                        <input name="optionKey_is_store_plan" value="yes" type="radio" {{Option::find_key($option,'is_store_plan') == 'yes'?'checked':''}}>
                                                        <span>فعال</span>
                                                    </label>
                                                </div>
                                                <div class="col m4 s12 ">
                                                    <label>
                                                        <input name="optionKey_is_store_plan" value="no" type="radio" {{Option::find_key($option,'is_store_plan') == 'no'?'checked':''}}>
                                                        <span>غیر فعال</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12">
                                            <div class="input-field">
                                                ...
                                                <input type="text" name="optionKey_app_version" required value="{{Option::find_key($option,'app_version')}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col m12 s12 grey lighten-3">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_pre_loading" value="enable" type="radio" {{Option::find_key($option,'pre_loading') == 'enable'?'checked':''}}>
                                                        <span>فعال</span>
                                                    </label>
                                                </div>
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_pre_loading" value="disable" type="radio" {{Option::find_key($option,'pre_loading') == 'disable'?'checked':''}}>
                                                        <span>غیر فعال</span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col m6 s12">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_product_mega_menu" value="enable" type="radio" {{Option::find_key($option,'product_mega_menu') == 'enable'?'checked':''}}>
                                                        <span>فعال</span>
                                                    </label>
                                                </div>
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_product_mega_menu" value="disable" type="radio" {{Option::find_key($option,'product_mega_menu') == 'disable'?'checked':''}}>
                                                        <span>غیر فعال</span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col m6 s12">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_product_level_menu" value="enable" type="radio" {{Option::find_key($option,'product_level_menu') == 'enable'?'checked':''}}>
                                                        <span>فعال</span>
                                                    </label>
                                                </div>
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_product_level_menu" value="disable" type="radio" {{Option::find_key($option,'product_level_menu') == 'disable'?'checked':''}}>
                                                        <span>غیر فعال</span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col s12 grey lighten-3">
                                            <div class="input-field-">
                                                ...
                                                <input type="text" name="optionKey_mobile_app_url" required dir="ltr" class="fill" value="{{Option::find_key($option,'mobile_app_url')}}" autocomplete="off" placeholder="مسیر پیشفرض حالت موبایل را وارد نمایید">
                                            </div>
                                        </div>
                                        <div class="col m12 s12">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_redirect_to_mobile" value="yes" type="radio" {{Option::find_key($option,'redirect_to_mobile') == 'yes'?'checked':''}}>
                                                        <span>بله</span>
                                                    </label>
                                                </div>
                                                <div class="col m6 s12 ">
                                                    <label>
                                                        <input name="optionKey_redirect_to_mobile" value="no" type="radio" {{Option::find_key($option,'redirect_to_mobile') == 'no'?'checked':''}}>
                                                        <span>خیر</span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col s12 grey lighten-3">
                                            <div class="input-field">
                                                ...
                                                <textarea class="browser-default w-100" rows="10" name="optionKey_about">{{Option::find_key($option,'about')}}</textarea>
                                            </div>
                                        </div>
