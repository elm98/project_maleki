$(document).ready(function () {
    $(".jsTreedefault").jstree(),
        ...
        $(".draggablejstree").jstree({ core: { check_callback: !0 }, plugins: ["dnd"] }),
        $(".wholerowjstree").jstree({ plugins: ["wholerow"] }),
        $(".contextmenujstree").jstree({ core: { check_callback: !0 }, plugins: ["contextmenu"] }),
        $(".searchablejstree").jstree({ plugins: ["search"] });
    var e = !1;
    $(".searchtree").keyup(function () {
        e && clearTimeout(e),
            (e = setTimeout(function () {
                var e = $(".searchtree").val();
                $(".searchablejstree").jstree(!0).search(e);
            }, 250));
    });
});
