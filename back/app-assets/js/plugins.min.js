...
function defaultMenuCollapse() {
    $("body").hasClass("menu-collapse") &&
        993 < $(window).width() &&
        (sidenavMain.removeClass("nav-lock"), $(".nav-collapsible .navbar-toggler i").text("radio_button_unchecked"), navCollapsible.removeClass("sideNav-lock"), toogleMenuCollapse(), navigationCollapse());
}
...
function navigationCollapse() {
    ...
    $(".sidenav-main.nav-collapsible").hasClass("nav-lock") ||
        ((n = $(".collapsible .open").children().length),
        ...
        setTimeout(function () {
            var e;
            1 < n && ((e = $(".sidenav-main .collapsible")), M.Collapsible.getInstance(e).close($(".collapsible .close").index()));
        }, 100));
}
function slideOutChat() {
    var e = $(".search").val();
    "" != e &&
        ((e = '<li class="collection-item display-flex avatar justify-content-end pl-5 pb-0" data-target="slide-out-chat"><div class="user-content speech-bubble-right"><p class="medium-small">' + e + "</p></div></li>"),
        $("#right-sidebar-nav #slide-out-chat .chat-body .collection").append(e),
        $(".search").val(""),
        0 < (e = $("#right-sidebar-nav #slide-out-chat .chat-body .collection")).length && (e[0].scrollTop = e[0].scrollHeight));
}
defaultMenuCollapse(),
    ...
    $(function () {
        ...
        null !== n && (n.indeterminate = !0),
            ...
            $(".dropdown-menu").dropdown({ inDuration: 300, outDuration: 225, constrainWidth: !1, hover: !1, hover: !1, gutter: 0, coverTrigger: !1, alignment: "right", closeOnClick: !1 }),
        ...
        n = document.querySelectorAll(".collapsible");
        M.Collapsible.init(n);
        n = document.querySelector(".collapsible.expandable");
        M.Collapsible.init(n, { accordion: !1 }),
            breadcrumbsWrapper.attr("data-image") && ((o = breadcrumbsWrapper.attr("data-image")), breadcrumbsWrapper.addClass("breadcrumbs-bg-image"), breadcrumbsWrapper.css("background-image", "url(" + o + ")"));
        var a,
            l,
            n = $("li.active .collapsible-sub .collapsible"),
            o = document.querySelectorAll(".sidenav-main .collapsible");
        M.Collapsible.init(o, {
            accordion: !0,
            ...
            $("body").hasClass("menu-collapse")
                ? ((o = $(".sidenav-main .collapsible")), 1 < $("#slide-out > li.active").children().length && $("#slide-out > li.active > a").parent().addClass("close"), M.Collapsible.getInstance(o).close($(".collapsible .close").index()))
                : 1 < $("#slide-out > li.active").children().length && $("#slide-out > li.active > a").parent().addClass("open"),
            0 < n.find("a.active").length && (n.find("a.active").closest("div.collapsible-body").show(), n.find("a.active").closest("div.collapsible-body").closest("li").addClass("active")),
            (a = (0 < $(".sidenav-main li a.active").parent("li.active").parent("ul.collapsible-sub").length
                ? $(".sidenav-main li a.active").parent("li.active").parent("ul.collapsible-sub")
            ...
            setTimeout(function () {
                void 0 !== a &&
                    $(".sidenav-main ul")
                        .stop()
                        .animate({ scrollTop: a.top - 300 }, 300);
            }, 300),
            $(".nav-collapsible .navbar-toggler").click(function () {
                toogleMenuCollapse(),
                    "radio_button_unchecked" == $(this).children().text()
                        ? ($(this).children().text("radio_button_checked"), sidenavMain.addClass("nav-lock"), navCollapsible.addClass("sideNav-lock"))
                        : ($(this).children().text("radio_button_unchecked"), sidenavMain.removeClass("nav-lock"), navCollapsible.removeClass("sideNav-lock"));
            }),
            $(".sidenav-main.nav-collapsible, .navbar .brand-sidebar").mouseenter(function () {
                $(".sidenav-main.nav-collapsible").hasClass("nav-lock") ||
                    ...
                    setTimeout(function () {
                        var e;
                        1 < $(".collapsible .open").children().length && ((e = $(".sidenav-main .collapsible")), M.Collapsible.getInstance(e).open($(".collapsible .open").index()));
                    }, 100));
            }),
            ...
            e()
                ...
                : (0 < $("#slide-out.leftside-navigation").length &&
                  ...
                  0 < $(".slide-out-right-body").length && new PerfectScrollbar(".slide-out-right-body, .chat-body .collection", { suppressScrollX: !0, wheelPropagation: !1 }),
                  0 < $(".chat-body .collection").length && new PerfectScrollbar(".chat-body .collection", { suppressScrollX: !0 }),
                  0 < $("#ul-horizontal-nav").length && (l = new PerfectScrollbar("#ul-horizontal-nav", { wheelPropagation: !1 })),
        ...
        n = $("#right-sidebar-nav #slide-out-chat .chat-body .collection");
        function e() {
            try {
        ...
        0 < n.length && (n[0].scrollTop = n[0].scrollHeight),
            ...
            $(".dropdown-language .dropdown-item").on("click", function () {
                ...
                e = e.find("a").data("language");
                i18next.changeLanguage(e, function (e, n) {
            ...
            0 < $("html[data-textdirection='rtl']").length && ($(".sidenav").sidenav({ edge: "right" }), $(".slide-out-right-sidenav").sidenav({ edge: "left" }), $(".slide-out-right-sidenav-chat").sidenav({ edge: "left" }));
    }),
    $(window).on("resize", function () {
        $(window).width() < 994
            ? sidenavMain.hasClass("nav-collapsed") && (sidenavMain.removeClass("nav-collapsed").addClass("nav-lock nav-expanded"), navCollapsible.removeClass("nav-collapsed").addClass("sideNav-lock"))
            : 993 < $(window).width() &&
              $("body").hasClass("menu-collapse") &&
              sidenavMain.hasClass("nav-lock") &&
              (sidenavMain.removeClass("nav-lock nav-expanded").addClass("nav-collapsed"), navCollapsible.removeClass("sideNav-lock").addClass("nav-collapsed"));
    });
